            ...
            <div className="Counter">
                <legend>
                    ...
                    <table>
                        <thead></thead>
                        <tbody>
                            <tr><td><CounterButton by={1} incrementMethod={this.increment} /></td>
                                <td><CounterButton by={-1} incrementMethod={this.increment} /></td></tr>
                            <tr><td><CounterButton by={5} incrementMethod={this.increment} /></td>
                                <td><CounterButton by={-5} incrementMethod={this.increment} /></td></tr>
